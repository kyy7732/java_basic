...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("========= 원하는 색상 사과 필터링 ===========");
        ...
        List<Integer> filter1 = filter(numbers, n -> n % 2 == 1); // 익명객체를 람다식으로 씀 test매개값을 n으로 받아서 2로 나눈값이 1이면 리턴하겠다.
        ...
        List<Integer> map1 = map(numbers, n -> n * n);// import static을 하여 map만 써도 됨 원래는 MappingApple.map()
