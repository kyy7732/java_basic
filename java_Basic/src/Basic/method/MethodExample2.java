...
//		}
	...
	static int calcNumberTotal2(int... nums) { // 여러개를 받을수 있다(가변인수)
		int total = 0;
		for(int n : nums) {
			total += n;
		}
	...
	public static void main(String[] args) {
		...
		int total = calcRangeTotal(34, 96);
		...
		sum = calcNumberTotal(new int[] {1,2,3,4,5,6,7}); // 바로 생성해서 보낼수도 있다.
		System.out.println("누적합: " + sum);
