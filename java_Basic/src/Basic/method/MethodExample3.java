...
public class MethodExample3 {
	...
	static void divide(int n1, int n2) {
		if(n2 == 0) {
			...
			return; // 메서드 강제 종료하는 방법 void에서만 가능
		}
		int result = n1 / n2;
	...
	public static void main(String[] args) {
        ...
        */
		...
		double[] value = calcArrayTotal(numbers);
		System.out.printf("값의 합계: %.0f, 평균: %.2f\n", value[0], value[1]);
...
//		int r4 = multi(10, 7); (x)// void는 리턴값이 없음 
